...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    InstallPromptCapture: typeof import('./components/install-prompt-capture.vue')['default']
    ...
    SSeasonExact: typeof import('./components/klicker/s-season-exact.vue')['default']
