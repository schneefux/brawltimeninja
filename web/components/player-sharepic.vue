<template>
  <div
    class="opacity-0 pointer-events-none absolute bottom-0 left-0"
  ...
  >
    ...
    <!-- https://www.business2community.com/brandviews/presto-media/best-social-media-image-sizes-photo-sharing-every-major-social-network-01911894 -->
      <div
        class="card__content flex flex-wrap bg-gray-800"
        ref="sharepic"
      >
        <div class="w-full flex items-center">
          ...
          <div class="ml-auto flex items-center">
            ...
            <div class="ml-3 border-2 border-primary-light rounded-full h-12 w-12 flex justify-center items-center">
              <span class="mb-1 text-4xl text-secondary font-bold">
                {{ accountRating }}
              </span>
            </div>
          </div>
        ...
        <div class="w-1/2 pl-1">
          ...
          <p class="-mr-5 text-xs text-right text-gray-400">
            brawltime.ninja
          </p>
        </div>
      </div>
