...
export default Vue.extend({
  ...
  computed: {
    ...
    statsTable(): string[][] {
      ...
      return [
        [ 'No ' + this.formatKind + ' ' + metaStatMaps.labels.winRate, metaStatMaps.formatters.winRate(this.withoutWinRate) ],
        [ this.formatName + ' ' + metaStatMaps.labels.winRate, metaStatMaps.formatters.winRate(this.winRate) ],
      ]
    },
